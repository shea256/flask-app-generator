...
# locate the file virtualenvwrapper.sh and paste the path to that file below
virtualenvwrapper_path = '~/../../usr/local/bin/virtualenvwrapper.sh'

# separate all packages with a space
packages_to_pip_install = 'flask gunicorn'

#---------------------------------------------------------------------#
# URL's for bootstrap docs, jquery docs, and favicon file
#---------------------------------------------------------------------#
